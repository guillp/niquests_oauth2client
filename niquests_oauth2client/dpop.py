...
class InvalidUseDPoPNonceResponse(Exception):
    ...
    def __init__(self, response: niquests.Response, message: str) -> None:
...
class DPoPToken(BearerToken):  # type: ignore[override]
    ...
    def _response_hook(self, response: niquests.Response, **kwargs: Any) -> niquests.Response:
...
class DPoPKey:
    ...
    def proof(self, htm: str, htu: str, ath: str | None = None, nonce: str | None = None) -> jwskate.SignedJwt:
        ...
        Proof will contain the following claims:
            ...
            - The `nonce` claim will be the value stored in the `nonce` attribute. This attribute is updated
              automatically when using a `DPoPToken` or one of the provided Authentication handlers as a `niquests`
              auth handler.
    ...
    def handle_as_provided_dpop_nonce(self, response: niquests.Response) -> None:
    ...
    def handle_rs_provided_dpop_nonce(self, response: niquests.Response) -> None:
